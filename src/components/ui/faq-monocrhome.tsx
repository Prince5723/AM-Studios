...
const faqs = [
  {
    question: "Do you provide editors?",
    answer:
      "Yes — basic audio editing is included in packages. full editing is available as an add ons.",
    meta: "Editing",
  },
  {
    question: "Can I bring my own gear?",
    answer:
      "Yes — subject to studio approval; technician must be informed in advance.",
    meta: "Gear",
  },
  {
    question: "How long until I get files?",
    answer:
      "Raw files within 48 hours, standard edits within 5-7 business days, rush edits available.",
    meta: "Delivery",
  },
  {
    question: "Is parking available?",
    answer:
    "Yes — The Cloverleaf offers visitor parking; please inform us ahead for reserved spots.",
    meta: "Parking",
  },
];
    ...
    <div className={`relative min-h-screen w-full overflow-hidden transition-colors duration-700 ${palette.surface}`}>
      ...
      >
        ...
        >
          ...
          <span className="faq1-intro__label">Studios FAQ</span>
        ...
        <header className="flex flex-col gap-8 md:flex-row md:items-end md:justify-between">
          <div className="space-y-4">
            ...
            <h1 className={`text-4xl font-semibold leading-tight md:text-5xl ${palette.heading}`}>
              Focus on the camera, not the noise.
            </h1>
            <p className={`max-w-xl text-base ${palette.muted}`}>
              Before you hit record, check out our studio's FAQ. Find answers about booking times, equipment provided, cancellation policies, engineer rates, and what to bring for a successful recording session.
            </p>
          </div>
        </header>
